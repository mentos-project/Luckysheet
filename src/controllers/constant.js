...
function menuToolBar (){
       ...
       return `<div class="luckysheet-toolbar-left-theme">
        ...
        <div class="luckysheet-toolbar-button luckysheet-inline-block" data-tips="${toolbar.sup}"
        ...
        <div class="luckysheet-toolbar-button luckysheet-inline-block" data-tips="${toolbar.sub}"
